...
getindex(z2field::DiscretePathIntegralZ2GaugeField, i::Int, j::Int, τ::Int) = z2field.data[bond(z2field.lattice, i, j)..., τ]
setindex!(z2field::DiscretePathIntegralZ2GaugeField, value, idx...) = z2field.data[idx...] = value
setindex!(z2field::DiscretePathIntegralZ2GaugeField, value, i::Int, j::Int, τ::Int) = z2field.data[bond(z2field.lattice, i, j)..., τ] = value
