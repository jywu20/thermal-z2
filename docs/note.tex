...
To ensure high accuracy, we have to use a $\Delta \tau$ small enough, especially for a large $h$.
...
\concept{Detrimental Quantum Monte Carlo (DQMC)} is a discrete path integral for fermions, 
