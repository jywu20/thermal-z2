...
% Text Node
\draw (112,121) node  [opacity=0.5]  {$\textcolor[rgb]{0,0,0}{1}$};
% Text Node
\draw (112,171) node  [opacity=0.5]   {$\textcolor[rgb]{0,0,0}{2}$};
% Text Node
\draw (112,221) node  [opacity=0.5]   {$\textcolor[rgb]{0,0,0}{3}$};
% Text Node
\draw (112,271) node  [opacity=0.5]   {$\textcolor[rgb]{0,0,0}{4}$};
% Text Node
...
% Text Node
\draw (162,121) node  [opacity=0.5]   {$\textcolor[rgb]{0,0,0}{5}$};
% Text Node
\draw (162,171) node  [opacity=0.5]   {$\textcolor[rgb]{0,0,0}{6}$};
% Text Node
