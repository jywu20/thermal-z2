...
%Shape: Square [id:dp7125368981997731] 
\draw  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,draw opacity=0.17 ] (60.52,69.52) -- (263.48,69.52) -- (263.48,272.48) -- (60.52,272.48) -- cycle ;
...
%Shape: Circle [id:dp9541631637841581] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (276.38,96.17) .. controls (276.38,90.93) and (280.63,86.68) .. (285.87,86.68) .. controls (291.11,86.68) and (295.36,90.93) .. (295.36,96.17) .. controls (295.36,101.41) and (291.11,105.66) .. (285.87,105.66) .. controls (280.63,105.66) and (276.38,101.41) .. (276.38,96.17) -- cycle ;

%Shape: Circle [id:dp23193277964870895] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (127.88,197.47) .. controls (127.88,192.23) and (132.13,187.98) .. (137.37,187.98) .. controls (142.61,187.98) and (146.86,192.23) .. (146.86,197.47) .. controls (146.86,202.71) and (142.61,206.96) .. (137.37,206.96) .. controls (132.13,206.96) and (127.88,202.71) .. (127.88,197.47) -- cycle ;

%Shape: Circle [id:dp9925233988383224] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (276.98,145.97) .. controls (276.98,140.73) and (281.23,136.48) .. (286.47,136.48) .. controls (291.71,136.48) and (295.96,140.73) .. (295.96,145.97) .. controls (295.96,151.21) and (291.71,155.46) .. (286.47,155.46) .. controls (281.23,155.46) and (276.98,151.21) .. (276.98,145.97) -- cycle ;

%Shape: Circle [id:dp22601221076415068] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (127.88,246.47) .. controls (127.88,241.23) and (132.13,236.98) .. (137.37,236.98) .. controls (142.61,236.98) and (146.86,241.23) .. (146.86,246.47) .. controls (146.86,251.71) and (142.61,255.96) .. (137.37,255.96) .. controls (132.13,255.96) and (127.88,251.71) .. (127.88,246.47) -- cycle ;
%Shape: Circle [id:dp9637668067212606] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (275.98,246.37) .. controls (275.98,241.13) and (280.23,236.88) .. (285.47,236.88) .. controls (290.71,236.88) and (294.96,241.13) .. (294.96,246.37) .. controls (294.96,251.61) and (290.71,255.86) .. (285.47,255.86) .. controls (280.23,255.86) and (275.98,251.61) .. (275.98,246.37) -- cycle ;

%Shape: Circle [id:dp9459840097782222] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (127.38,297.97) .. controls (127.38,292.73) and (131.63,288.48) .. (136.87,288.48) .. controls (142.11,288.48) and (146.36,292.73) .. (146.36,297.97) .. controls (146.36,303.21) and (142.11,307.46) .. (136.87,307.46) .. controls (131.63,307.46) and (127.38,303.21) .. (127.38,297.97) -- cycle ;

%Shape: Circle [id:dp3671035568911951] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (225.88,295.47) .. controls (225.88,290.23) and (230.13,285.98) .. (235.37,285.98) .. controls (240.61,285.98) and (244.86,290.23) .. (244.86,295.47) .. controls (244.86,300.71) and (240.61,304.96) .. (235.37,304.96) .. controls (230.13,304.96) and (225.88,300.71) .. (225.88,295.47) -- cycle ;

%Shape: Circle [id:dp8786540161067065] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (177.38,95.97) .. controls (177.38,90.73) and (181.63,86.48) .. (186.87,86.48) .. controls (192.11,86.48) and (196.36,90.73) .. (196.36,95.97) .. controls (196.36,101.21) and (192.11,105.46) .. (186.87,105.46) .. controls (181.63,105.46) and (177.38,101.21) .. (177.38,95.97) -- cycle ;

%Shape: Circle [id:dp8191070716122306] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (175.38,145.97) .. controls (175.38,140.73) and (179.63,136.48) .. (184.87,136.48) .. controls (190.11,136.48) and (194.36,140.73) .. (194.36,145.97) .. controls (194.36,151.21) and (190.11,155.46) .. (184.87,155.46) .. controls (179.63,155.46) and (175.38,151.21) .. (175.38,145.97) -- cycle ;

%Shape: Circle [id:dp3769142309494904] 
\draw  [draw opacity=0][fill={rgb, 255:red, 255; green, 255; blue, 255 }  ,fill opacity=1 ] (177.38,295.97) .. controls (177.38,290.73) and (181.63,286.48) .. (186.87,286.48) .. controls (192.11,286.48) and (196.36,290.73) .. (196.36,295.97) .. controls (196.36,301.21) and (192.11,305.46) .. (186.87,305.46) .. controls (181.63,305.46) and (177.38,301.21) .. (177.38,295.97) -- cycle ;
...
% Text Node
\draw (310.76,56.8) node [anchor=west] [inner sep=0.75pt]    {$y$};
% Text Node
\draw (47.6,320.34) node [anchor=north] [inner sep=0.75pt]    {$x$};
% Text Node
...
\langle 1,5\rangle =1=\left( 1,\text{A}\right) =\left( 1,1,\text{A}\right)\\
\langle 2,6\rangle =2=\left( 2,\text{A}\right) =\left( 2,1,\text{A}\right)\\
\langle 1,2\rangle =17=\left( 1,\text{B}\right) =\left( 1,1,\text{B}\right)
\end{array}$};
% Text Node
...
% Text Node
\draw (286.87,95.17) node    {$1$};
% Text Node
\draw (138.37,196.47) node    {$7$};
% Text Node
\draw (287.47,144.97) node    {$2$};
% Text Node
\draw (138.37,245.47) node    {$8$};
% Text Node
\draw (286.47,245.37) node    {$4$};
% Text Node
\draw (137.87,296.97) node    {$5$};
% Text Node
\draw (236.37,294.47) node    {$13$};
% Text Node
\draw (162,221) node    {$\textcolor[rgb]{0,0,0}{7}$};
% Text Node
\draw (162,271) node    {$\textcolor[rgb]{0,0,0}{8}$};
% Text Node
\draw (187.87,94.97) node    {$9$};
% Text Node
\draw (162,142.6) node [anchor=south] [inner sep=0.75pt]  [color={rgb, 255:red, 255; green, 0; blue, 0 }  ,opacity=1 ]  {$6$};
% Text Node
\draw (162,192.6) node [anchor=south] [inner sep=0.75pt]  [color={rgb, 255:red, 255; green, 0; blue, 0 }  ,opacity=1 ]  {$7$};
% Text Node
\draw (162,242.6) node [anchor=south] [inner sep=0.75pt]  [color={rgb, 255:red, 255; green, 0; blue, 0 }  ,opacity=1 ]  {$8$};
% Text Node
\draw (185.87,144.97) node    {$10$};
% Text Node
\draw (135,271) node [anchor=east] [inner sep=0.75pt]  [color={rgb, 255:red, 0; green, 0; blue, 255 }  ,opacity=1 ]  {$24$};
% Text Node
\draw (185,121) node [anchor=east] [inner sep=0.75pt]  [color={rgb, 255:red, 0; green, 0; blue, 255 }  ,opacity=1 ]  {$25$};
% Text Node
\draw (185,171) node [anchor=east] [inner sep=0.75pt]  [color={rgb, 255:red, 0; green, 0; blue, 255 }  ,opacity=1 ]  {$26$};
% Text Node
\draw (185,221) node [anchor=east] [inner sep=0.75pt]  [color={rgb, 255:red, 0; green, 0; blue, 255 }  ,opacity=1 ]  {$27$};
% Text Node
\draw (185,271) node [anchor=east] [inner sep=0.75pt]  [color={rgb, 255:red, 0; green, 0; blue, 255 }  ,opacity=1 ]  {$28$};
% Text Node
\draw (187.87,294.97) node    {$9$};
